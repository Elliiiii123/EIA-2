...
(function (GenerativeKunst) {
    ...
    function drawDiamond(_position, _rotation) {
        console.log("Diamond");
        let sizeX = 40;
        let sizeY = 60;
    ...
    function drawDiamondInCircle(center, radius, numDiamonds) {
    ...
    function drawBubbles(_position, _size) {
        ...
        let r1 = 1;
        let r2 = 20;
        let gradient2 = crc2.createRadialGradient(0, 0, r1, 0, 0, r2);
    ...
    function drawBubblesInCircle(center, radius, numDiamonds, outerSize, innerSize) {
        let numRows = 3;
    ...
    function drawRandomShapes(numShapes, _offset) {
